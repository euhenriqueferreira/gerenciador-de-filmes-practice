    ...
    <div class="w-3/5">
        ...
        <div class="flex flex-wrap justify-between gap-2">
            <div class="flex h-12 border-2 border-gray-900 rounded-md px-4 w-full">
                <label for="titulo" class="flex items-center justify-center mr-2">
                ...
                <input type="text" id="titulo" name="titulo" class="w-full bg-transparent text-base font-nunito font-normal text-gray-400 focus:outline-none placeholder:opacity-55" placeholder="Título">
            </div>
            <?php 
                // dd($_SESSION);
                    $flash = flashMessage()->get('validacoes_cadastrar_filme');
